...
published: true
layout: default
title: websharpstudios on GNU+Linux and other UNIXes, Almost There
---
...
Continue <a href="../gnulinux-dl">this way</a>.
</div>
...
function downloadClicked() {
	...
	window.setTimeout(function () { window.location.href = "http://websharpstudios.github.io/en-US/downloads/gnulinux-dl/"; }, 500);
}
